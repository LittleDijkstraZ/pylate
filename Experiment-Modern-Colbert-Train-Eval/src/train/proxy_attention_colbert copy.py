...
run_name = f"ProxyAttention-Alibaba-ColBERT-{num_select_tokens}tok-{lr}-lr-{num_train_epochs}-epochs-{training_mode}-bs{batch_size}-nway{n_ways}"
...
args = SentenceTransformerTrainingArguments(
    ...
    gradient_checkpointing_kwargs={"use_reentrant": False},  # Required for DDP compatibility
    eval_strategy="steps",
    eval_steps=500,
    save_steps=5000,
    logging_steps=20,
